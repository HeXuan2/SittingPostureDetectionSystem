...
class ML_Model():
    def __init__(self,data,fea_start=0,fea_end=5,targetname = 'target'):
        self.data = data
        #数据处理
...
class SL_Model():
    ...
    def score_mean(self):
        ...
        self.mean = (self.score_s+self.score_d+self.score_k)/3
        return self.mean
    ...
    def select_model(self):
        ...
        self.max_score = max(self.score_s, self.score_d, self.score_k)
